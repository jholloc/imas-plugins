...
public:
    ...
    std::string toString() const
    {
        ...
        oss << "ApproxVector( " << Catch::Detail::stringify(vector_) << " )";
        return oss.str();
    }
...
template<>
struct StringMaker<Catch::Detail::ApproxVector> {
    static std::string convert(Catch::Detail::ApproxVector const& value)
    {
        return value.toString();
    }
};
