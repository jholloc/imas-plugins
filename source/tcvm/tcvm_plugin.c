...
int do_help(IDAM_PLUGIN_INTERFACE* idam_plugin_interface)
{
    const char* help = PLUGIN_NAME ": this plugin maps TCV data to IDS using MATLAB\n\n";
    const char* desc = PLUGIN_NAME ": help = plugin used for mapping TCV data to IDS using MATLAB";
