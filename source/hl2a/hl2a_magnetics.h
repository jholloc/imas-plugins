...
//void magnetics_flux_loop_identifier(int shotNumber, DATA_BLOCK* data_block, int* nodeIndices);
...
void magnetics_test2D_hl2a(int shotNumber, DATA_BLOCK* data_block, int* nodeIndices);
